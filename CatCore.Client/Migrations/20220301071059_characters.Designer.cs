...
namespace CatCore.Client.Migrations
{
    ...
    [Migration("20220301071059_characters")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatCore.Data.Character", b =>
                {
            ...
            modelBuilder.Entity("CatCore.Data.CharacterAttribute", b =>
                {
            ...
            modelBuilder.Entity("CatCore.Data.GuildCharacterAttribute", b =>
                {
                    b.Property<int>("GuildCharacterAttributeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("GuildCharacterAttributeId");

                    b.HasIndex("GuildId");

                    b.ToTable("GuildCharacterAttributes");
                });
            ...
            modelBuilder.Entity("CatCore.Data.Character", b =>
                {
                    b.HasOne("CatCore.Data.User", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CatCore.Data.Guild", null)
                        .WithMany("Characters")
            ...
            modelBuilder.Entity("CatCore.Data.CharacterAttribute", b =>
                {
                    b.HasOne("CatCore.Data.GuildCharacterAttribute", "Base")
                        .WithMany()
                        .HasForeignKey("BaseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CatCore.Data.Character", "Character")
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("CatCore.Data.GuildCharacterAttribute", b =>
                {
                    b.HasOne("CatCore.Data.Guild", null)
                        .WithMany("GuildCharacterAttributes")
                        .HasForeignKey("GuildId");
                });
            ...
            modelBuilder.Entity("CatCore.Data.Guild", b =>
                {
                    ...
                    b.Navigation("GuildCharacterAttributes");
