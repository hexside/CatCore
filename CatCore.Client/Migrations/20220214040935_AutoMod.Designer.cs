...
namespace CatCore.Client.Migrations
{
    ...
    [Migration("20220214040935_AutoMod")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatCore.Data.RegexAction", b =>
                {
                    ...
                    b.Property<bool>("TriggerByDefault")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CatCore.Data.RegexActionCondition", b =>
                {
                    b.Property<ulong?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("RegexActionConditionId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("RegexActionId");

                    b.ToTable("RegexActionTriggers");
                });
            ...
            modelBuilder.Entity("CatCore.Data.RegexActionCondition", b =>
                {
                    b.HasOne("CatCore.Data.RegexAction", "RegexAction")
                        .WithMany()
                        .HasForeignKey("RegexActionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RegexAction");
                });
